        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    $get_content = "select * from outdoor_service where outdoor_service_Category='Investigation/Test'";
                    //echo $get_content;
                    $getJson = $conn->prepare($get_content);
                    $getJson->execute();
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 proclinic-box-shadow">
                            <h3 class="widget-title">Investigation/Test</h3>
                            <form class="form-horizontal form-material mb-0" id="patient_service_form" method="post" enctype="multipart/form-data">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="hidden" name="outdoor_treatment_outdoor_service_Category" value="Investigation/Test">
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                if (document.getElementById("outdoor_treatment_indoor_treatment_id").value) {
                    document.getElementById("outdoor_treatment_total_paid").value = 0;
                    document.getElementById("outdoor_treatment_total_paid").readOnly  = true;
                }
