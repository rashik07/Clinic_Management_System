                                    ...
                                    <table id="datatable1" class="table table-bordered table-hover" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tfoot id="datatable1_foot">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <input type="text" id="pharmacy_selling_vat" onchange="total_calculation_update();" class="text-right form-control" name="pharmacy_selling_vat" placeholder="0.00" value="<?php echo $result_content_medicine_sell[0]['pharmacy_sell_vat']; ?>" readonly="readonly" tabindex="15">
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <input type="text" id="pharmacy_selling_discount" onchange="total_calculation_update();" class="text-right form-control" name="pharmacy_selling_discount" placeholder="0.00" value="<?php echo $result_content_medicine_sell[0]['pharmacy_sell_discount']; ?>" readonly="readonly" tabindex="16">
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <input type="text" id="pharmacy_selling_exemption" onchange="total_calculation_update();" class="text-right form-control" name="pharmacy_selling_exemption" placeholder="0.00" value="<?php echo $result_content_medicine_sell[0]['pharmacy_selling_exemption']; ?>" readonly="readonly" tabindex="16">
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <input type="text" id="pharmacy_selling_paid_amount" onchange="total_calculation_update();" class="text-right form-control" name="pharmacy_selling_paid_amount" placeholder="0.00" required value="<?php echo $result_content_medicine_sell[0]['pharmacy_sell_paid_amount']; ?>" readonly="readonly" tabindex="18">
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
