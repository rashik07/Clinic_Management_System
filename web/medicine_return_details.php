                ...
                where pharmacy_sell_medicine_sell_id='$medicine_sell_id'";
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 proclinic-box-shadow">
                            <h3 class="widget-title">Medicine Sell Return</h3>
                            <form class="form-horizontal form-material mb-0" id="medicine_sell_return_update_form" method="post" enctype="multipart/form-data">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" placeholder="Return Date" class="form-control" id="pharmacy_sell_return_date" name="pharmacy_sell_return_date" value="<?php echo $result_content_return[0]['pharmacy_sell_return_date']?>" required readonly>
                                    </div>
                                    ...
                                    <table id="datatable1" class="table table-bordered table-hover" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Return Quantity<i class="text-danger"> * </i></th>
                                        ...
                                        <tfoot id="datatable1_foot">
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <input type="text" id="pharmacy_sell_return_net_price" class="text-right form-control" name="pharmacy_sell_return_net_price" placeholder="0.00" value="<?php echo $result_content_return[0]['pharmacy_sell_return_net_price']?>" readonly="">
                                                </td>
                                                <!-- <td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('form#medicine_sell_return_update_form').on('submit', function(event) {
            event.preventDefault();
            spinner.show();
            var formData = new FormData(this);

            $.ajax({
                url: '../apis/update_medicine_sell_return.php',
                type: 'POST',
                data: formData,
    ...
    function invoice() {
        form = document.getElementById('medicine_sell_return_update_form');
        form.target = '_blank';
        ...
        if (obj != null && obj.length > 0) {
            ...
            for (var i = 0; i < Object.keys(all_medicine).length; i++) {
                if (all_medicine[i]['medicine_name'] === name && all_medicine[i]['pharmacy_medicine_batch_id'] === batch_id) {
                    ...
                    var selling_pieces = row.find(".pharmacy_medicine_return_quantity").val();
                    console.log(selling_pieces);
    ...
    function initRowTable() {
        ...
        for (var i = 0; i < Object.keys(list).length; i++) {
            ...
            text7.setAttribute("class", "form-control pharmacy_medicine_return_quantity");
            text7.setAttribute("placeholder", "return");
            text7.setAttribute("name", "pharmacy_medicine_return_quantity[]");
            text7.setAttribute("id", "pharmacy_medicine_return_quantity");
            text7.setAttribute("readonly", "readonly");
            text7.setAttribute("value", list1[i]['pharmacy_sell_medicine_return_piece']);
            text7.onchange = function() {
                row_update(this);
            }
            ...
            text8.setAttribute("class", "form-control pharmacy_purchase_medicine_total_selling_price");
            text8.setAttribute("placeholder", "total");
            text8.setAttribute("name", "pharmacy_purchase_medicine_total_selling_price[]");
            text8.setAttribute("id", "pharmacy_purchase_medicine_total_selling_price");
            text8.setAttribute("readonly", "readonly");
            text8.setAttribute("value", list1[i]['pharmacy_sell_medicine_return_total_selling_price']);
