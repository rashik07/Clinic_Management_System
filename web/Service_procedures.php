        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    $get_content = "select * from outdoor_service where outdoor_service_Category='Procedures'";
                    //echo $get_content;
                    $getJson = $conn->prepare($get_content);
                    $getJson->execute();
                            ...
                            <form class="form-horizontal form-material mb-0" id="patient_service_form" method="post" enctype="multipart/form-data">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="hidden" name="outdoor_treatment_outdoor_service_Category" value="Procedures">
