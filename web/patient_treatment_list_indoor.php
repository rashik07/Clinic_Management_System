                            ...
                            <div class="table-responsive mb-3">
                                <table id="datatable1" class="table " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        inner join patient on outdoor_treatment.outdoor_treatment_patient_id = patient.patient_id where outdoor_treatment_indoor_treatment_id IS NOT NULL ORDER BY outdoor_treatment_id DESC";
