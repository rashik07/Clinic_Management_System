                            ...
                            <form class="form-horizontal form-material mb-0" id="medicine_sell_return_update_form" method="post" enctype="multipart/form-data">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" placeholder="Return Date" class="form-control" id="pharmacy_sell_return_date" name="pharmacy_sell_return_date" value="<?php echo $result_content_return[0]['pharmacy_sell_return_date']?>" required>
                                    </div>
