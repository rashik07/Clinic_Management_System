                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select id="outdoor_treatment_consultant" class="form-control outdoor_treatment_consultant" name="outdoor_treatment_consultant" placeholder="Pick a Service..." value="<?php echo $result_content_treatment[0]['outdoor_treatment_consultant']; ?>" required readonly>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9"><input type="number" placeholder="Exemption" class="form-control" id="outdoor_treatment_exemption" name="outdoor_treatment_exemption" onchange="update_total_bill();" value="<?php echo $result_content_treatment[0]['outdoor_treatment_exemption']; ?>" readonly></div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9"><input type="number" placeholder="Total Paid" class="form-control" onchange="update_payment();" id="outdoor_treatment_total_paid" name="outdoor_treatment_total_paid" value="<?php echo $result_content_treatment[0]['outdoor_treatment_total_paid']; ?>" required readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-12" style="display: none;">
                                            <div class="row">
                                                <div class="col-md-3"><label for="discharge-date">Due</label></div>
                                                <div class="col-md-9"><input type="number" placeholder="Total Due" class="form-control" id="outdoor_treatment_total_due2" name="outdoor_treatment_total_due2" value="<?php echo $result_content_treatment[0]['outdoor_treatment_total_due']; ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                <div class="col-md-3"><label for="discharge-date">Due collection<i class="text-danger"> * </i></label></div>
                                                <div class="col-md-9"><input type="number" min=1 max=<?php echo $result_content_treatment[0]['outdoor_treatment_total_due']; ?> placeholder="Due" class="form-control" onchange="update_payment_due();" id="outdoor_treatment_due_collection" name="outdoor_treatment_due_collection" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9"><input type="text" placeholder="Card/Check No" class="form-control" id="outdoor_treatment_payment_type_no" name="outdoor_treatment_payment_type_no" value="<?php echo $result_content_treatment[0]['outdoor_treatment_payment_type_no']; ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9"><input type="text" placeholder="Note" class="form-control" id="outdoor_treatment_note" name="outdoor_treatment_note" value="<?php echo $result_content_treatment[0]['outdoor_treatment_note']; ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    function update_payment_due() {
        var outdoor_treatment_total_due = parseInt(document.getElementById("outdoor_treatment_total_due2").value);
        var due_collection = parseInt(document.getElementById("outdoor_treatment_due_collection").value);
        if (outdoor_treatment_total_due > due_collection || due_collection == outdoor_treatment_total_due) {
            due_collection = isNaN(parseInt(due_collection)) ? 0 : due_collection;
            ...
            total_paid = parseInt(total_paid) + parseInt(due_collection);
            var total_due = parseInt(total_bill) - parseInt(total_paid);
            document.getElementById("outdoor_treatment_total_due").value = total_due;
            document.getElementById("outdoor_treatment_total_paid").value = total_paid;
        }
    }
