...
// true then header redirect it to the home page directly
{
    ...
    if ($_SESSION['loggedIn'] == false || $_SESSION['user_Status'] == "Not Active" || ($_SESSION['user_type_access_level'] > 2 && $_SESSION['user_type_access_level'] != 3 && $_SESSION['user_type_access_level'] != 4)) {
        echo '<script type="text/javascript"> window.open("login.php","_self");</script>';            //  On Successful Login redirects to home.php
        exit();
    }
}
