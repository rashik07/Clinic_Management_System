...
from medicine
            ...
            left join pharmacy_medicine pm on medicine.medicine_id = pm.pharmacy_medicine_medicine_id";
                    ...
                    $get_content = "select * from ot_treatment left join patient pt ON ot_treatment_patient_id=pt.patient_id left join indoor_treatment on ot_treatment.ot_treatment_indoor_treatment_id = indoor_treatment.indoor_treatment_id where ot_treatment_id='$ot_treatment_id'";
                    //echo $get_content;
                    $getJson = $conn->prepare($get_content);
                    $getJson->execute();
                            ...
                            <form class="form-horizontal form-material mb-0" id="patient_allotment_form" method="post" enctype="multipart/form-data">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" placeholder="Admission ID" class="form-control" id="indoor_treatment_admission_id" name="indoor_treatment_admission_id" value="<?php echo $result_content_treatment[0]['indoor_treatment_admission_id'] ?>" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
