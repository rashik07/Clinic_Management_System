    ...
    function post()
    {
        ...
        if ($check_token && $check_permission) {
            try {
                ...
                $pharmacy_selling_exemption = if_empty($_POST['pharmacy_selling_exemption']);
            ...
            pharmacy_sell_date= '$pharmacy_sell_date',
                ...
                pharmacy_sell_discount = '$pharmacy_selling_discount', pharmacy_selling_exemption = '$pharmacy_selling_exemption', pharmacy_sell_grand_total='$pharmacy_selling_grand_total',
