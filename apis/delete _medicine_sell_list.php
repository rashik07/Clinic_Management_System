...
class DeleteMedicine
{
    ...
    function delete()
    {
        ...
        if ($check_token && $check_permission) {
            try {
                $get_content = "select * from pharmacy_sell_return WHERE pharmacy_sell_medicine_sell_id='$pharmacy_sell_id'";
                ...
                if ($result) {
                    ...
                    echo json_encode(array("medicine" => "Error", $status => 0, $message => "Delete Medicine Failed/ Please Check Return List"));
                }
                die();
            } catch (Exception $e) {
