    ...
    function post(){
        ...
        if($check_token && $check_permission)
        {
            try {
                ...
                $indoor_patient_doctor_doctor_id = if_empty($_POST['indoor_patient_doctor_doctor_id']);
                $indoor_doctor_specialization  = if_empty($_POST['doctor_specialization']);
                $indoor_doctor_visit_fee = if_empty($_POST['doctor_visit_fee']);
                $indoor_doctor_total_bill = if_empty($_POST['doctor_total_bill']);
                $indoor_patient_doctor_entry_time = if_empty($_POST['indoor_patient_doctor_entry_time']);
                $indoor_patient_doctor_discharge_time = if_empty($_POST['indoor_patient_doctor_discharge_time']);
                ...
                $post_content = "INSERT INTO indoor_treatment (indoor_treatment_user_added_id,
                              ...
                              indoor_treatment_note, indoor_treatment_admission_date,
                              indoor_treatment_referer_doctor_id, indoor_treatment_service_charge) 
