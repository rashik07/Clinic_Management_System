...
(
    ...
    `outdoor_treatment_doctor_id`                 int(11) NOT NULL,
    ...
    FOREIGN KEY (outdoor_treatment_doctor_id) REFERENCES doctor (doctor_id)
...
(
    ...
    `indoor_treatment_referer_doctor_id`         int(11) NOT NULL,
    `indoor_treatment_total_bill`                varchar(255) DEFAULT NULL, --
    `indoor_treatment_service_charge`            varchar(255) DEFAULT NULL, --
    ...
    `indoor_treatment_admission_date`            DATETIME     DEFAULT CURRENT_TIMESTAMP,
    ...
    FOREIGN KEY (indoor_treatment_referer_doctor_id) REFERENCES doctor (doctor_id)
...
CREATE TABLE `indoor_treatment_service`
(
    `indoor_treatment_service_id`                int(11) NOT NULL AUTO_INCREMENT,
    `indoor_treatment_service_user_added_id`     int(11) NOT NULL,
    `indoor_treatment_service_treatment_id`      int(11) NOT NULL,
    `indoor_treatment_service_service_id`        int(11) NOT NULL,
    `indoor_treatment_service_service_quantity`  varchar(255) DEFAULT NULL, --
    `indoor_treatment_service_service_rate`      varchar(255) DEFAULT NULL, --
    `indoor_treatment_service_service_total`     varchar(255) DEFAULT NULL, --
    `indoor_treatment_service_creation_time`     DATETIME     DEFAULT CURRENT_TIMESTAMP,
    `indoor_treatment_service_modification_time` DATETIME ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (indoor_treatment_service_id),
    FOREIGN KEY (indoor_treatment_service_user_added_id) REFERENCES user (user_id),
    FOREIGN KEY (indoor_treatment_service_treatment_id) REFERENCES indoor_treatment (indoor_treatment_id),
    FOREIGN KEY (indoor_treatment_service_service_id) REFERENCES outdoor_service (outdoor_service_id)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8;
...
(
    ...
    FOREIGN KEY (pathology_investigation_test_treatment_id) REFERENCES indoor_treatment (indoor_treatment_id), -- main patient instance
...
(
    ...
    `medicine_category`          int(11) DEFAULT NULL,
...
CREATE TABLE `indoor_pharmacy_sell_medicine`
(
    `indoor_pharmacy_sell_medicine_id`                  int(11) NOT NULL AUTO_INCREMENT,
    `indoor_pharmacy_sell_medicine_user_added_id`       int(11) NOT NULL,
    `indoor_pharmacy_sell_medicine_medicine_id`         int(11) NOT NULL,
    `indoor_pharmacy_sell_medicine_treatment_id`        int(11) NOT NULL,
    `indoor_pharmacy_sell_medicine_batch_id`            varchar(255) DEFAULT NULL,
    `indoor_pharmacy_sell_medicine_per_piece_price`     varchar(255) DEFAULT NULL,
    `indoor_pharmacy_sell_medicine_selling_piece`       varchar(255) DEFAULT NULL,
    `indoor_pharmacy_sell_medicine_total_selling_price` varchar(255) DEFAULT NULL,
    `indoor_pharmacy_sell_medicine_note`                varchar(255) DEFAULT NULL,
    `indoor_pharmacy_sell_medicine_creation_time`       DATETIME     DEFAULT CURRENT_TIMESTAMP,
    `indoor_pharmacy_sell_medicine_modification_time`   DATETIME ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (indoor_pharmacy_sell_medicine_id),
    FOREIGN KEY (indoor_pharmacy_sell_medicine_user_added_id) REFERENCES user (user_id),
    FOREIGN KEY (indoor_pharmacy_sell_medicine_medicine_id) REFERENCES pharmacy_medicine (pharmacy_medicine_id),
    FOREIGN KEY (indoor_pharmacy_sell_medicine_treatment_id) REFERENCES indoor_treatment (indoor_treatment_id)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8;
...
(
    ...
    `ot_treatment_item_qty`                       varchar(255) DEFAULT NULL,
    `ot_treatment_item_total`                     varchar(255) DEFAULT NULL,
    ...
    FOREIGN KEY (ot_treatment_item_treatment_id) REFERENCES indoor_treatment (indoor_treatment_id)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8;
