...
INSERT INTO
  `user_type` (
    `user_type_id`,
    `user_type_Name`,
    `user_type_access_level`,
    `user_type_creation_time`,
...
VALUES
  (
    ...
    '01671080275',
    'rifat',
    'abdullahalrifat95@gmail.com',
    '3ff4480e30247f9a1d8bad4efe7e1055',
    'active',
    '2022-05-11 12:14:41',
    '2022-05-11 12:14:41',
    1
  ...
  (
    ...
    'admin',
    'admin@gmail.com',
    '25805144c083ad8d5e5974a6668cbfd4',
    'active',
    '2022-05-11 12:14:41',
    '2022-05-22 22:21:05',
    1
  ...
  (
    ...
    '01000000000',
    'normal_admin',
    'normal_admin@gmail.com',
    'af4a57797a8428477fa9ebd4ea7397ba',
    'active',
    '2022-05-11 12:14:41',
    '2022-05-22 19:44:23',
    2
  ...
  (
    ...
    'Salam',
    'salam@mtcclinic.com',
    'f7e85f9db96883fa4a6421634f1b3c86',
    '',
    NULL,
    '2022-05-24 16:33:21',
    3
  ...
  (
    ...
    'CEO',
    'ceo@mtcclinic.org',
    '6fdcccf4592c5aab563a25bb1c2c56a0',
    'active',
    NULL,
    NULL,
    2
  ...
  (
    ...
    '0168888888',
    'khairul',
    'khairul@mtcclinic.org',
    '7a6ba1e8a319ebafdbce2b02d5fa0e89',
    'active',
    NULL,
    '2022-05-24 16:33:29',
    4
...
CREATE TABLE `patient` (
  ...
  `patient_refered_by` varchar(255) DEFAULT NULL,
  ...
  FOREIGN KEY (patient_user_added_id) REFERENCES user (user_id) -- UNIQUE (patient_phone)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
INSERT INTO
  `doctor` (
    ...
    `doctor_visit_fee`,
    `doctor_phone`,
    `doctor_emergency_phone`,
    `doctor_address`,
    `doctor_status`,
    `photo_url`,
    `document_url`,
    `doctor_creation_time`,
    `doctor_modification_time`
  )
VALUES
  (
    5,
    2,
    'Assoc.Prof.Dr.Johurul Hoque',
    '',
    'Head Of Dept.Of Orthopedic',
    'Surgeon',
    '45',
    '',
    '',
    ...
    '01819061993',
    '',
    '56,Block-A(2nd Floor),Road-03,Dhaka Real State,Katasur,Mohammadpur,Dhaka-1207',
    'active',
    '',
    '',
    '2022-05-21 16:04:27',
  ...
  (
    ...
    'Towhidul Islam',
    '',
    'Pain,Arthritis,Sports injuries CP& Rehab Mnage',
    'BSC PT(Faculty Of Medicine -DU)',
    '28',
    '',
    '',
    '',
...
INSERT INTO
  `outdoor_service` (
    `outdoor_service_id`,
    `outdoor_service_user_added_id`,
    `outdoor_service_name`,
    `outdoor_service_Category`,
    `outdoor_service_room_no`,
    `outdoor_service_description`,
    `outdoor_service_rate`,
    `outdoor_service_creation_time`,
    `outdoor_service_modification_time`
  )
VALUES
  (
    14,
  ...
  (
    130,
    2,
    'X-Ray Right Shoulder Joint B/V',
    'Investigation/Test',
    '203',
    '',
    '450',
  ...
  (
    143,
    2,
    'X-Ray Pelvis Including Hip A/P View',
    'Investigation/Test',
    '203',
    '',
    '600',
  ...
  (
    144,
    2,
    'X-Ray Chest Left Lateral Slide Hip',
    'Investigation/Test',
    '203',
    '',
    '500',
  ...
  (
    152,
    2,
    'X-Ray Chest Right Obligue View',
    'Investigation/Test',
    '203',
    '',
    '500',
  ...
  (
    155,
    2,
    'X-Ray Left Temperomandibular Joint ',
    'Investigation/Test',
    '203',
    '',
    '800',
...
CREATE TABLE `pharmacy_payment` (
  `pharmacy_payment_id` int(11) NOT NULL AUTO_INCREMENT,
  `pharmacy_payment_user_added_id` int(11) NOT NULL,
  `pharmacy_payment_pharmacy_sell_id` int(11) NOT NULL,
  `pharmacy_payment_details` varchar(2550) DEFAULT NULL,
  `pharmacy_payment_amount` int(11) DEFAULT 0,
  `pharmacy_payment_due` int(11) DEFAULT 0,
  `pharmacy_payment_increase` int(11) DEFAULT 1,
  `pharmacy_payment_creation_time` DATETIME DEFAULT CURRENT_TIMESTAMP,
  `pharmacy_payment_modification_time` DATETIME ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (pharmacy_payment_id),
  FOREIGN KEY (pharmacy_payment_pharmacy_sell_id) REFERENCES pharmacy_sell (pharmacy_sell_id)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE `pharmacy_sell` (
  ...
  `pharmacy_sell_sub_total` varchar(255) DEFAULT 0,
  `pharmacy_sell_vat` varchar(255) DEFAULT 0,
  `pharmacy_sell_discount` varchar(255) DEFAULT 0,
  `pharmacy_selling_exemption` varchar(255) DEFAULT 0,
  `pharmacy_sell_grand_total` varchar(255) DEFAULT 0,
  `pharmacy_sell_paid_amount` varchar(255) DEFAULT 0,
  `pharmacy_sell_due_amount` varchar(255) DEFAULT 0,
...
CREATE TABLE `pharmacy_sell_return` (
  ...
  `pharmacy_sell_return_indoor_treatment_id` int(11) DEFAULT NULL,
  `pharmacy_sell_return_date` DATETIME DEFAULT CURRENT_TIMESTAMP,
  `pharmacy_sell_return_net_price` varchar(255) DEFAULT 0,
  `pharmacy_sell_return_creation_time` DATETIME DEFAULT CURRENT_TIMESTAMP,
  `pharmacy_sell_return_modification_time` DATETIME ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `pharmacy_sell_medicine_return` (
  `pharmacy_sell_medicine_return_id` int(11) NOT NULL AUTO_INCREMENT,
  `pharmacy_sell_medicine_return_user_added_id` int(11) NOT NULL,
  `pharmacy_sell_medicine_return_medicine_id` int(11) NOT NULL,
  `pharmacy_sell_medicine_return_sell_id` int(11) NOT NULL,
  `pharmacy_sell_medicine_return_medicine_batch_id` varchar(255) DEFAULT NULL,
  `pharmacy_sell_medicine_return_per_piece_price` varchar(255) DEFAULT NULL,
  `pharmacy_sell_medicine_return_piece` varchar(255) DEFAULT NULL,
  `pharmacy_sell_medicine_return_total_selling_price` varchar(255) DEFAULT NULL,
  `pharmacy_sell_medicine_return_creation_time` DATETIME DEFAULT CURRENT_TIMESTAMP,
  `pharmacy_sell_medicine_return_modification_time` DATETIME ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (pharmacy_sell_medicine_return_id),
  FOREIGN KEY (pharmacy_sell_medicine_return_user_added_id) REFERENCES user (user_id),
  FOREIGN KEY (pharmacy_sell_medicine_return_medicine_id) REFERENCES pharmacy_medicine (pharmacy_medicine_id),
  FOREIGN KEY (pharmacy_sell_medicine_return_sell_id) REFERENCES pharmacy_sell_return (pharmacy_sell_return_id)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;